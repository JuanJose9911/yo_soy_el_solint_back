        ...
        <div>
           ...
           <img src="{{public_path('logosacas.png')}}" style="width: 90px; height: 90px" alt="logo2" >
            ...
            <table class="w-100 mt-4">
                <tr>
                    <td>
                        <strong><p  style="font-size: 15px; text-align: left ">TABLA DE AMORTIZACIÓN </p></strong>
                    </td>
                    <td>
                        <p >{{$day}}</p>
                    </td>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="td-left w-td-2">
                            <div
                                style="padding-left: 5px; padding-right: 2px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden;">
                                <strong>Pagaré Nro. </strong> {{$payNumber}}
                            </div>
                        </td>
                        <td class="td-left w-td-2">
                            <div
                ...
                <tbody>
                    @foreach ($fees as $fee)
                        <tr style=" padding-top:-1px">
                            ...
                            <td class="td-center">${{ number_format($fee['fee']) }}</td>
                            <td class="td-center">${{ number_format($fee['interest_due']) }}</td>
                            <td class="td-center">${{ number_format($fee['due']) }}</td>
                            <td class="td-center">{{ $fee['state'] }}</td>
                            <td class="td-center">${{ number_format($fee['credit_due']) }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
